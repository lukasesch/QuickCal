# QuickCal
QuickCal is an iOS app designed to help users track their nutrition and calculate personalized calorie and macronutrient goals. The app is built using the **SwiftUI** framework, follows the **MVVM** architectural pattern, and stores user data with **Core Data**. By integrating external food databases via **REST APIs** (**OpenFoodFacts**), users can easily search for foods and scan barcodes, supported by the **AVFoundation** framework.<br>
<br>
